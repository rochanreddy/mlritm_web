...
export default function ComputerScienceEngineeringPage() {
  const departmentData = {
    ...
    programs: [
      "B.Tech in Computer Science & Engineering (Intake: 120 students)",
      "M.Tech in Computer Science & Engineering (Intake: 18 students)",
      "M.Tech in Artificial Intelligence & Machine Learning (Intake: 18 students)"
    ],
    highlights: [
